...
$$x_n=\lambda_1(2^n)+\lambda_2(n)(2^n)$$
y ahora se checan los valores iniciales para que nos dé los valores de $\lambda_1$ y $\lambda_2$.
...
con $i^2=-1$, $a$ parte real, $b$ parte imaginaria.
